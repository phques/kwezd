...
// PQuesnel, 2012-08, slightly modified to compile w. gdc.exe (mingw tdm64-1) 4.6.1 !!!
...
//                static if(SkipWhitespace) skipWhitespace();
                static if(SkipWhitespace) while(isWhite(peekChar())) next = 0;
...
//                static if(SkipWhitespace) skipWS();
                static if(SkipWhitespace) while(isWhite(peekChar())) next = 0;
                auto c2 = getChar();
